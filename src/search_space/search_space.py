...
class SearchSpace(object):
    ...
    def nn_collision_check(self, nn_node):
        """
        The neural network samples a location within X_free
        :return: the bool of the node is located within X_free
        """
        if self.obstacle_free(nn_node):
            return True
        else:
            return False
